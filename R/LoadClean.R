...
#'  assignID = c("County", "DED", "Year"))
#' @export
LoadCleanRaw_fread <- function(path, file_delim = " ", assignID=NULL, preProcess = FALSE){
    dat <- suppressWarnings(suppressMessages(data.table::fread(path,
                             strip.white = TRUE,
...
# path = "data/census_ireland_1901/Dublin/Arran_Quay.txt"
# file_delim = " "
# assignID = c("County", "DED", "Year")
# preProcess = FALSE
#
# system.time({
#   LoadCleanRaw(path = "data/census_ireland_1901/Dublin/Arran_Quay.txt",
#                file_delim = " ",
#                assignID = c("County", "DED", "Year"),
#                preProcess = FALSE)
# })
#
# system.time({
#   LoadCleanRaw_fread(path = "data/census_ireland_1901/Dublin/Arran_Quay.txt",
#                      assignID = c("County", "DED", "Year"),
#                      preProcess = FALSE)
# })
